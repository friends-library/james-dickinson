[.style-blurb, short="Testimony of Pardshaw Meeting"]
...
but for want of keeping a steadfast eye to the guidings thereof,
...
in divers counties through England, Ireland, and Scotland;
